      ...
      <SignUp.Root>
        ...
        >
          ...
          <SignUp.Strategy name="email_code">
            ...
            <SignUp.Action
              submit
              className="mt-4 w-full px-4 py-2 bg-yellow-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase"
            >
              Verify
            </SignUp.Action>
          </SignUp.Strategy>
